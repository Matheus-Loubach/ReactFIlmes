  ...
  return (
    <div className='Ultimos'>
      ...
      <div className='grid-container'>
        {dados ? dados.all.filter(filme => filme.categoria.toLowerCase().includes('comédia')).slice(0, tamanhoF).map(filme => <DetalhesFilmes key={filme.nome} item={filme}  />) : <span>Carregando...Aguarde</span>}
      </div>
